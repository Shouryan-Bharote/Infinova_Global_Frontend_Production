...
const EduventuresForStudentsHeroSection = () => {
  return (
    ...
    >
      ...
      <div className="flex flex-col md:flex-row w-full h-auto md:h-[75vh]">
        {/* Mobile-only spacing */}
<div className="block md:hidden h-8"></div>
        {/* Left Side (Text) */}
        <div className="w-full md:w-1/2 flex items-center justify-center p-6 md:p-12">
          <div className="text-center md:text-left space-y-3 md:space-y-4 lg:space-y-6 font-extrabold ">
            
            {/* Split lines */}
            <h1 className="font-extrabold leading-snug text-3xl sm:text-4xl md:text-5xl lg:text-[75px] text-gray-900">
...
<h1 className="font-extrabold leading-snug text-3xl sm:text-4xl md:text-5xl lg:text-[75px] mb-4 text-gray-900">
  Now!!!
</h1>
